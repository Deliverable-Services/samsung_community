...
class CustomAudioSliderThumb extends SliderComponentShape {
  final double thumbRadius;
  final double borderWidth;

  const CustomAudioSliderThumb({
...
class CustomAudioTrackShape extends SliderTrackShape {
  @override
  ...
  Widget build(BuildContext context) {
    return SliderTheme(
      data: SliderTheme.of(context).copyWith(
        ...
        trackShape: CustomAudioTrackShape(),
        thumbShape: CustomAudioSliderThumb(
          thumbRadius: 6.r,
          borderWidth: 4.w,
        ),
